<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="DivisionLib.aspx.vb" Inherits="DivisionLib" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">  </asp:ScriptManager>
            ...
            <asp:TemplateField HeaderText="CODE" SortExpression="DIVCODE">
                ...
                <InsertItemTemplate>
                    <asp:TextBox ID="txtCode" runat="server" Text='<%# Bind("DIVCODE") %>' 
                        Width="80px" MaxLength="8" ToolTip="Max length is 8"></asp:TextBox>
                    &nbsp;
    ...
    <br />
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            UpdateCommand="UPDATE [DIVISIONLIB] SET [DIVCODE] = @DIVCODE, [DIVISION] = @DIVISION, [DTE] = { fn NOW() }, [USERID] = @USERID WHERE [SECCODE] = @SECCODE">
            <DeleteParameters>
        ...
        ConnectionString="<%$ ConnectionStrings:NPASISConnectionString %>" 
            ...
            UpdateCommand="UPDATE [DIVISIONLIB] SET [DIVCODE] = @DIVCODE, [DIVISION] = @DIVISION, [DTE] = { fn NOW() }, [USERID] = @USERID WHERE [FOACODE] = @FOACODE">
            <DeleteParameters>
                <asp:Parameter Name="DIVCODE" Type="String" />
            </DeleteParameters>
            <InsertParameters>
