...
public partial class ProductInquiry : System.Web.UI.Page
{
    ...
    protected void GridViewInventory_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[1].Text = "Total: " + prod.GetTotalInventory().ToString() + "&nbsp&nbsp&nbsp&nbsp&nbspDisposed:" + prod.GetTotalOrder().ToString();
            e.Row.Cells[0].Text ="Balance: " + (prod.GetTotalInventory() - prod.GetTotalOrder()).ToString();
        }
