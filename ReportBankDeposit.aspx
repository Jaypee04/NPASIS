<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReportBankDeposit.aspx.cs" Inherits="ReportBankDeposit" %>
...
&nbsp;&nbsp;
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="ReportBankDeposit.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" 
                    Name="DataSetBankDeposit" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        TypeName="DataSetBankDepositTableAdapters.BANKDEPOSITSTableAdapter">
        <SelectParameters>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetData" 
        TypeName="DSSignatoryTableAdapters.SIGNTORISLIBTableAdapter">
    </asp:ObjectDataSource>
</asp:Content>
