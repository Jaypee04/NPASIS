...
public partial class ReportDetailedCollection : System.Web.UI.Page
{
    ...
    private void LoadReportDataSource(string msocode, DateTime startdate, DateTime enddate)
    {
        ...
        DetailedCollection.ORDERFLDataTable dt = new DetailedCollection.ORDERFLDataTable();
        DetailedCollectionTableAdapters.ORDERFLTableAdapter ad = new DetailedCollectionTableAdapters.ORDERFLTableAdapter();
        ad.Fill(dt, msocode, startdate, enddate);
       

        ReportDataSource rds = new ReportDataSource("DSDetailedCollection", (DataTable)dt);
