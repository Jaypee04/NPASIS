...
public partial class ReportTopSelling : System.Web.UI.Page
{
    ...
    private void LoadReportDataSource(Int32 top, DateTime startdate, DateTime enddate)
    {
        ...
        DataSetTopSelling.DataTableTopSellingDataTable dt = new DataSetTopSelling.DataTableTopSellingDataTable();
        DataSetTopSellingTableAdapters.DataTableTopSellingTableAdapter ad = new DataSetTopSellingTableAdapters.DataTableTopSellingTableAdapter();
                     

        ad.Fill(dt,top, startdate, enddate);

        ReportDataSource rds = new ReportDataSource("TopSelling", (DataTable)dt);
